var e={get Orientation(){return{portrait:`portrait`,landscape:`landscape`}},async print(){window.print()},async printToFileAsync(){window.print()}};e.Orientation;async function t(t={}){return await e.printToFileAsync(t)}function n(e){let t=e.grade===`A`?`#FFD700`:e.grade===`B`?`#C0C0C0`:`#CD7F32`,n=e.grade===`A`?`with Distinction`:e.grade===`B`?`with Merit`:``;return`
<!DOCTYPE html>
<html>
<head>
  <meta charset="utf-8" />
...
</html>`}async function r(e){try{let{uri:r}=await t({html:n(e),base64:!1,width:1100,height:850});return r}catch(e){return console.error(`[CertificateGenerator] Failed to generate PDF:`,e),null}}var i=0;function a(){return i++,`TOR-${Date.now().toString(36).toUpperCase()}-${i.toString(36).toUpperCase().padStart(4,`0`)}-${Math.random().toString(36).substring(2,6).toUpperCase()}`}function o(e){return e===void 0?`C`:e>=90?`A`:e>=75?`B`:`C`}export{o as calculateGrade,r as generateCertificatePDF,a as generateSerialNumber};
//# sourceMappingURL=certificateGenerator-CpUVI5xi.js.map