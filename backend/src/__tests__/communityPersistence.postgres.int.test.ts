/**
 * ============================================================================
 * Toroloom Community Persistence — PostgreSQL Integration
 * ============================================================================
 *
 * Validates the full community post lifecycle against a real PostgreSQL
 ...
 *
 * Run:
 *   npx vitest run --reporter=verbose src/__tests__/communityPersistence.postgres.int.test.ts
 *
 * Skip:
...
describe('Community Persistence — PostgreSQL', () => {
  ...
  beforeAll(async () => {
    ...
    try {
      ...
      console.warn(
        `⚠ PostgreSQL not available (${err.message}) — skipping Community Persistence + PG tests`,
      );
      available = false;
    }
  }, 30_000);
