/**
 * ============================================================================
 * Toroloom Notification Persistence — PostgreSQL Integration
 * ============================================================================
 *
 * Validates the full notification lifecycle against a real PostgreSQL
 ...
 *
 * Run:
 *   npx vitest run --reporter=verbose src/__tests__/notificationPersistence.postgres.int.test.ts
 *
 * Skip:
...
describe('Notification Persistence — PostgreSQL', () => {
  ...
  beforeAll(async () => {
    ...
    try {
      ...
      console.warn(
        `⚠ PostgreSQL not available (${err.message}) — skipping Notification Persistence + PG tests`,
      );
      available = false;
    }
  }, 30_000);
