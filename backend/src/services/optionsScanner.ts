/**
 * ============================================================================
 * Toroloom — Options Scanner Service (Backend)
 * ============================================================================
 *
 ...
 *   const result = scanMarket(optionChainResponse, 'NIFTY');
 *
 * ============================================================================
 */

// ──── Types (self-contained — mirrors the route-level OptionContract) ──────
...
export function scanMarket(
  ...
  const suggestions = generateSuggestions(condition);
...
function generateSuggestions(
  ...
  // Collar (when holding the underlying)
  if (bias === 'bullish') {
    suggestions.push({
      strategyName: 'Collar',
      strategyId: 'collar',
