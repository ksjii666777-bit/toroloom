...
[![Deployed on Railway](https://img.shields.io/badge/Railway-Deployed-9D50FE?style=flat&logo=railway&logoColor=white)](https://toroloom-production.up.railway.app)

**Live deployment:** [`https://toroloom-production.up.railway.app`](https://toroloom-production.up.railway.app) — REST API + WebSocket, auto-deployed on every `master` push.
